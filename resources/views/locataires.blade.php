...
<div class="card">
        ...
        <li><a href="{{ route('locataire.index') }}" title="Liste Locataire">Liste Locataire</a></li>
            ...
            <p class="card-header-title">Création d'un Locataire</p>
        </header>
        <div class="card-content">
            <div class="content">
                <form action="{{ route('locataire.store') }}" method="POST">
                    ...
                    <div class="control">
                    <input class="input @error('prenom') is-danger @enderror" type="text" name="prenom" id="prenom" value="{{ old('prenom') }}"> <br>
                    </div>
                        @error('prenom')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="control">
                    <input class="input @error('loyer') is-danger @enderror" type="text" name="loyer" id="loyer" value="{{ old('loyer') }}"><br>
                    </div>
                        @error('loyer')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="control">
                    <input class="input @error('creance') is-danger @enderror" type="text" name="creance" id="creance" value="{{ old('creance') }}"><br>
                    </div>
                        @error('creance')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="control">
                    <input class="input @error('impaye') is-danger @enderror" type="text" name="impaye" id="impaye" value="{{ old('impaye') }}"><br>
                    </div>
                        @error('impaye')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="control">
                    <input class="input @error('id_bloc') is-danger @enderror" type="text" name="id_bloc" id="id_bloc" value="{{ old('id_bloc') }}"><br>
                    </div>
                        @error('id_bloc')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <input class="input @error('logement') is-danger @enderror" type="text" name="id_logement" id="logement" value="{{ old('logement') }}">
                    </div>
                        @error('logement')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
